const TWITCH_CHANNEL = "CallyKally";

const TWITCH_CHANNEL_ID = 91074520;
...
const REDIRECT_URI = "https://www.pointbot.w4.websr.fr";
...
function main() {
    if (!twitch.isAuthenticated()) {
        ...
        console.log(twitch.getUserId(TWITCH_CHANNEL));
		console.log(twitch.getLastFollowers(TWITCH_CHANNEL_ID))
	}
}
